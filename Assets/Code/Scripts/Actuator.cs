...
namespace Code.Scripts
{
    public class Actuator : MonoBehaviour, IWandActuator
    {
        ...
        {
            public IEnumerable<IActuatorMovable> GetMovables();
        }
        ...
        private void HandleWandStick(IEnumerable<IActuatorMovable> inRange)
        {
        ...
        private void HandleWandButtons(IEnumerable<IActuatorMovable> inRange)
        {
            //TODO: Implement
        }

        private static void ReduceToSingle(List<IActuatorMovable> inRange, List<IActuatorMovable> notInRange)
        {
        ...
        private void Update()
        {
            var movables = WandManager.Instance.MovableProvider?.GetMovables() ?? new List<IActuatorMovable>();
            ...
            ReduceToSingle(actuatorMovables, notInRange);
            ...
            HandleWandStick(actuatorMovables);
            HandleWandButtons(actuatorMovables);
        }
    }
}
